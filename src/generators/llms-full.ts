 ...
 */
export function generateLlmsFullTxt(docs: ProcessedDocs, config: Config): string {
  const lines: string[] = [];
 ...
 */
function processSection(section: DocSection, lines: string[], config: Config): void {
 ...
 */
function addPageBlock(page: DocPage, lines: string[], config: Config): void {
