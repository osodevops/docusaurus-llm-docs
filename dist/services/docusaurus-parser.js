 ...
 */
export async function processDocusaurusBuild(config, sections) {
    const pages = new Map();
 ...
 */
async function findHtmlFiles(buildDir) {
 ...
 */
function buildHtmlMapping(htmlFiles, buildDir) {
 ...
 */
function findHtmlForPage(page, htmlMap, _buildDir) {
 ...
 */
function updateSectionsWithContent(sections, pages) {
 ...
 */
export async function discoverPagesFromBuild(buildDir, config) {
...
//# sourceMappingURL=docusaurus-parser.js.map