...
turndown.addRule('inlineCode', {
    ...
    replacement: (content) => {
        ...
        const backtickCount = (content.match(/`+/g) || []).reduce((max, match) => Math.max(max, match.length), 0);
 ...
 */
export function convertHtmlToMarkdown(html, stripHtml = true) {
 ...
 */
function removeRemainingHtml(content) {
